...
const createLimiter = (
  ...
  if (process.env.NODE_ENV === 'test') {
    const noop: RateLimitRequestHandler = ((req: Request, res: Response, next: NextFunction) =>
 ...
 * Usiamo skipSuccessfulRequests: true così che solo i login falliti vengano conteggiati.
 */
